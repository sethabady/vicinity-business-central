query 50168 "VICAdjustments"
{
    QueryType = API;
    APIPublisher = 'Vicinity';
    APIGroup = 'App1';
    APIVersion = 'v1.0';
    EntityName = 'VICAdjustments';
    EntitySetName = 'VICAdjustments';
    Caption = 'Vicinity Adjustments and Transfers';

    elements
    {
        dataitem(Item_Ledger_Entry; "Item Ledger Entry")
        {
            DataItemTableFilter = "Entry Type" = filter(= 'Positive Adjmt.' | 'Negative Adjmt.' | 'Transfer');
